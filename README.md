...
```bash
git clone https://github.com/SantosJGND/resfinder_parser.git
cd resfinder_parser
```
...
```
python main.py -r /path/to/RESFINDER_DIR -o /path/to/output_dir
```
...
Planned improvements include enhanced filtering options and extended command-line flexibility.

## Citation

If you use resfinder_parser in your work, please cite:
Xxx (Santos JG et al. resfinder_parser. GitHub repository.??)
